...
export default function BlogArea() {
    return (
        <div id="blog" className="blog-area secondary-bg pt-155 pb-120">
                ...
                <div className="row mb-5 mb-md-0">
                    <div className="col-6">
                        <div className="title">
                            ...
                            <h2 className="text-uppercase">Recent Blog</h2>
                        </div>
                    </div>
                    <div className="col-6 align-self-end">
                        <div className="ui-slide-box d-flex justify-content-end align-items-center">
                            <button className="ui-slide-btn" id="ui-prev-btn">
                                <i className="l-a fas fa-angle-left"></i>
                            </button>
                            <button className="ui-slide-btn" id="ui-next-btn">
