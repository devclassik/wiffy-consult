                            ...
                            <div className="row align-items-center justify-content-center">
                                <div className="col-xl-10 col-lg-11  col-md-12 col-sm-12 col-12">
                                    <div className="content-wrapper">
                                        <h2 className="modal-title f-700 text-center">
                                            Lets make the begging to mankind to
                                            save the world again
                                        </h2>
                                        <ul className="blog-meta mb-30 d-flex align-items-center justify-content-between ml-auto mr-auto w-50">
                                            <li>
                                                <Link
                                                    href="/"
                                            ...
                                            <li>
                                                <span className="secondary-color d-block">
                                                    <span className="mr-1">
                                            ...
                                            <div className="row align-items-center justify-content-md-between">
                                                <div className="col-xl-7 col-lg-7  col-md-12 col-sm-12 col-12">
                                                    <div className="modal-tags d-sm-flex align-items-center pt-25">
                                                        <h6 className="primary-font-family mb-0 pr-15 f-700">
                                                            Tags :
                                                        </h6>
                                                        <ul className="tag-list">
                                                            ...
                                                            {tags.map(
                                                                (item, i) => (
                                                                    <li
                                                                        key={i}
                                                                        className="d-inline-block pr-10 f-600"
                                                                    >
                                                                        <Link
                                                                            className="secondary-color d-block"
                                                                            href={
                                                                                item.path
                                                                            }
                                                                        >
                                                ...
                                                <div className="col-xl-5 col-lg-5  col-md-12 col-sm-12 col-12">
                                                    <div className="pro-modal-social-link d-flex align-items-center justify-content-lg-end pt-25">
                                                        <h6 className="primary-font-family text-uppercase pr-15 f-700 mb-0 pb-0">
                                                            Share :
                                                        </h6>
